    ...
    bool fill)
{
    ...
    std::vector<VertexFormat> vertices =
    {
        ...
        VertexFormat(corner + glm::vec3(3000, 0, 0), color),
        VertexFormat(corner + glm::vec3(3000, 3000, 0), color),
        VertexFormat(corner + glm::vec3(0, 3000, 0), color)
    };
    ...
    bool fill)
{
    ...
    {
        VertexFormat(corner, color),
        VertexFormat(corner + glm::vec3(2000, 0, 0), color),
        VertexFormat(corner + glm::vec3(2000, 150, 0), color),
        VertexFormat(corner + glm::vec3(0, 150, 0), color)
    };
    ...
    bool fill)
{
    ...
    {
        VertexFormat(corner, color),
        VertexFormat(corner + glm::vec3(125, 0, 0), color),
        VertexFormat(corner + glm::vec3(125, 50, 0), color),
...
Mesh* object2D::CreatePunctajUpgrade(
    const std::string& name,
    glm::vec3 leftBottomCorner,
    float length,
    glm::vec3 color,
    bool fill)
{
    ...
    {
        VertexFormat(corner, color),
        VertexFormat(corner + glm::vec3(25, 0, 0), color),
        VertexFormat(corner + glm::vec3(25, 50, 0), color),
        VertexFormat(corner + glm::vec3(0, 50, 0), color)
    };
    ...
    bool fill)
{
    ...
    std::vector<VertexFormat> vertices =
    {
        ...
        VertexFormat(corner + glm::vec3(length / 3, length/3, 0), color)
    };
    ...
    bool fill)
{
    ...
    std::vector<VertexFormat> vertices =
    {
        ...
        VertexFormat(corner + glm::vec3(length/3, 1.5*length, 0), color)
    };
